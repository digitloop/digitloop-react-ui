...
function DialogContent({
  ...
  return /* @__PURE__ */ React14.createElement(DialogPortal, { "data-slot": "dialog-portal" }, /* @__PURE__ */ React14.createElement(DialogOverlay, null), /* @__PURE__ */ React14.createElement(
    ...
    children,
    /* @__PURE__ */ React14.createElement(DialogPrimitive.Close, { className: "ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4" }, /* @__PURE__ */ React14.createElement(XIcon, null), /* @__PURE__ */ React14.createElement("span", { className: "sr-only" }, "Close"))
  ));
}
...
function CommandInput({
  ...
  return /* @__PURE__ */ React15.createElement(
    ...
    /* @__PURE__ */ React15.createElement(SearchIcon, { className: "size-4 shrink-0 opacity-50" }),
...
function DataTable({
  ...
  return /* @__PURE__ */ React17.createElement(React17.Fragment, null, /* @__PURE__ */ React17.createElement(Table, null, table.getRowCount() === 0 && /* @__PURE__ */ React17.createElement(TableCaption, { className: "text-center" }, "No data"), /* @__PURE__ */ React17.createElement(TableHeader, null, table.getHeaderGroups().map((headerGroup) => {
    return /* @__PURE__ */ React17.createElement(TableRow, { key: headerGroup.id }, headerGroup.headers.map((header) => {
      return /* @__PURE__ */ React17.createElement(Fragment2, { key: header.id }, flexRender(
    ...
    return /* @__PURE__ */ React17.createElement(
      ...
      row.getVisibleCells().map((cell) => {
        return /* @__PURE__ */ React17.createElement(Fragment2, { key: cell.id }, flexRender(
...
var LoadingSpinner = ({ className }) => {
  return /* @__PURE__ */ React24.createElement(LoaderCircle, { className: cn("size-4 animate-spin", className) });
};
...
function Pagination({
  ...
  return /* @__PURE__ */ React25.createElement("nav", { "aria-label": "Pagination" }, /* @__PURE__ */ React25.createElement("ul", { className: "flex space-x-1 mb-0 items-center" }, /* @__PURE__ */ React25.createElement(
    ...
    /* @__PURE__ */ React25.createElement(
      ...
      renderItem({
        page: 1,
        children: /* @__PURE__ */ React25.createElement(ChevronsLeftIcon, { size: iconSize }),
        searchParams: params
      })
    )
    ...
    renderItem({
      page: currentPage - 1,
      children: /* @__PURE__ */ React25.createElement(ChevronLeftIcon, { size: iconSize }),
      searchParams: params
    })
    ...
    children: `${1}`,
    searchParams: params
  }))), currentPage > renderPage && /* @__PURE__ */ React25.createElement("li", { className: "text-muted-foreground px-2 hidden lg:block" }, /* @__PURE__ */ React25.createElement(EllipsisIcon, { size: iconSize })), pages.map((e, i) => {
    ...
    renderItem({
      page: currentPage + 1,
      children: /* @__PURE__ */ React25.createElement(ChevronRightIcon2, { size: iconSize }),
      searchParams: params
    })
    ...
    renderItem({
      page: totalPage,
      children: /* @__PURE__ */ React25.createElement(ChevronsRightIcon, { size: iconSize }),
      searchParams: params
    })
  ))));
}
...
var PasswordInput = React26.forwardRef(({ ...props }, ref) => {
  ...
  return /* @__PURE__ */ React26.createElement("div", { className: "relative" }, /* @__PURE__ */ React26.createElement(Input, { ref, ...props, type: inputType, className: "pe-10" }), /* @__PURE__ */ React26.createElement("div", { className: "absolute right-1 top-0 bottom-0 flex items-center" }, /* @__PURE__ */ React26.createElement(
    ...
    inputType === "password" ? /* @__PURE__ */ React26.createElement(EyeOffIcon, { size: 20 }) : /* @__PURE__ */ React26.createElement(EyeIcon, { size: 20 })
  )));
});
...
function SelectTrigger({
  ...
  return /* @__PURE__ */ React30.createElement(
    ...
    children,
    /* @__PURE__ */ React30.createElement(SelectPrimitive.Icon, { asChild: true }, /* @__PURE__ */ React30.createElement(ChevronDownIcon2, { className: "size-4 opacity-50" }))
  );
}
...
function SelectItem({
  ...
  return /* @__PURE__ */ React30.createElement(
    ...
    /* @__PURE__ */ React30.createElement("span", { className: "absolute right-2 flex size-3.5 items-center justify-center" }, /* @__PURE__ */ React30.createElement(SelectPrimitive.ItemIndicator, null, /* @__PURE__ */ React30.createElement(CheckIcon3, { className: "size-4" }))),
...
function SelectScrollUpButton({
  ...
  return /* @__PURE__ */ React30.createElement(
    ...
    /* @__PURE__ */ React30.createElement(ChevronUpIcon, { className: "size-4" })
  );
}
function SelectScrollDownButton({
  ...
  return /* @__PURE__ */ React30.createElement(
    ...
    /* @__PURE__ */ React30.createElement(ChevronDownIcon2, { className: "size-4" })
  );
}
